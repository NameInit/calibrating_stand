...
struct BoardParams {
	...
	BoardParams() :
		board_width(ParamsManager::getInstance()["chessboard"]["board_width"]),
		board_height(ParamsManager::getInstance()["chessboard"]["board_height"]),
		square_size(ParamsManager::getInstance()["chessboard"]["square_size"]) {}
};
