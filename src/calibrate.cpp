...
//TODO: сделать отдельную папку для результатов 
//TODO: избавиться от char*
//TODO: поправить отладочные выводы, сделать их понятнее и лаконичнее
//TODO: сделать динамический квадрат для стерео изображения, то есть координаты квадрата [x,y,w,h] и его показывать в окне, а не весь
//TODO: мб потом сделать конфиги в json
//TODO: перенести остальные классы, которые написаны на питоне
//TODO: добавить проверки в rectifier_image.hpp
//TODO: попробовать наложить фильтры на датасет
//TODO: добавить сборку cmake
int main(){
